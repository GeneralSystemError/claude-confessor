...
echo -e "${BLUE}[2/5]${NC} Installing templates..."
...
echo -e "${BLUE}[3/5]${NC} Configuring Claude Code..."
...
echo -e "${BLUE}[4/5]${NC} Setting up memory system..."
...
3. Or run the interactive setup:
   ${BLUE}cat ${SCRIPT_DIR}/prompts/SETUP.md | pbcopy${NC}
   Then paste into Claude Code and follow the prompts.
...
- Forget: "Forget about [thing]"
- Check: "What do you remember about me?"
- Save skill: "Save this as a reusable skill"
